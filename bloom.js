...
d>0?i<u:i>u;
i+=s)r.push(i) ;
return r} ) ( (0) , (words) , (1) ) ) ,it.size=words instanceof Array?words.length:words,it.mask= (function(it) {return( ( (it.size& (it.size-1) ) && ( (function( ) {throw new Error( ( 'Caterwaul Bloom filter: ' + (it.size) + ' is not a power of two' ) ) } ) .call(this) ) ) ) ,it} ) .call(this, (it.size-1) ) ,it.hs=hs) ,it} ) .call(this, (this) ) } ,$.merge($.bloom.array.prototype, {set_bit:function(n) {;
return this.table[n>>>5&this.mask] |= (1<< (n&31) ) } ,get_bit:function(n) {;
return this.table[n>>>5&this.mask] & (1<< (n&31) ) } ,hash:function() {;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x0=xs[0] ,xi=1,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,x0= (x^x0) ;
return x0} ) .call(this,this.table) } ,density:function() {;
return(function(xs) {var x,x0,xi,xl,xr;
...
return x0} ) .call(this,this.table) } ,add:function() { ( (function(items) {var item,item0,itemi,iteml,itemr;
...
return this} ,merge:function(f) {var tt=this.table;
var ft=f.table;
 ( (function(xs) {var x,x0,xi,xl,xr;
for(var xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] , (tt[xi] |=ft[xi] ) ;
return xs} ) .call(this,tt) ) ;
return this} ,select:function(f) {var tt=this.table;
var ft=f.table;
 ( (function(xs) {var x,x0,xi,xl,xr;
for(var xi=0,xl=xs.length;
xi<xl;
...
xi<xl;
 ++xi) {x=xs[xi] ;
if(x1= ( !this.get_bit(x(item) ) ) )return false}return true} ) .call(this,this.hs) } ,union:function(f) {var ft=f.table;
return $.bloom(this.hs, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (x|ft[xi] ) ) ;
return xr} ) .call(this,this.table) ) } ,intersect:function(f) {var ft=f.table;
return $.bloom(this.hs, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (x&ft[xi] ) ) ;
return xr} ) .call(this,this.table) ) } ,subset:function(f) {var ft=f.table;
return(function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x1;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x1= ( (x&ft[xi] ) !==x) )return false}return true} ) .call(this,this.table) } ,reduce_to:function(size) {;
...
return(function(it) {return(it.value=v||0,it.size=1,it.hs=hs) ,it} ) .call(this, (this) ) } ,$.merge($.bloom.single.prototype, {set_bit:function(n) {;
