...
return x0} ) .call(this,this.table) } ,add:function() {var xs=arguments;
...
return items} ) .call(this,xs) ) ) } ,contains:function(item) {;
return! ( (function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x1;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x1= ( !this.get_bit(x(item) ) ) )return x1}return false} ) .call(this,this.hs) ) } ,union:function(f) {;
return(function( ) {var ft=f.table;
return($.bloom(this.hs, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (x|ft[xi] ) ) ;
return xr} ) .call(this,this.table) ) ) } ) .call(this) } ,intersect:function(f) {;
return(function( ) {var ft=f.table;
return($.bloom(this.hs, (function(xs) {var x,x0,xi,xl,xr;
for(var xr=new xs.constructor() ,xi=0,xl=xs.length;
xi<xl;
 ++xi)x=xs[xi] ,xr.push( (x&ft[xi] ) ) ;
return xr} ) .call(this,this.table) ) ) } ) .call(this) } ,subset:function(f) {;
return(function( ) {var ft=f.table;
return( ! ( (function(xs) {var x,x0,xi,xl,xr;
for(var x=xs[0] ,xi=0,xl=xs.length,x1;
xi<xl;
 ++xi) {x=xs[xi] ;
if(x1= ( (x&ft[xi] ) !==x) )return x1}return false} ) .call(this,this.table) ) ) } ) .call(this) } ,reduce_to:function(size) {;
...
return(x-=x>>>1&0x55555555,x= (x&0x33333333) + ( (x>>>2) &0x33333333) , (x+ (x>>>4) &0xf0f0f0f) *0x1010101>>>24) } ,add:function() {var xs=arguments;
return(function(it) {return(this) } ) .call(this, ( (function(items) {var item,item0,itemi,iteml,itemr;
for(var itemi=0,iteml=items.length;
itemi<iteml;
 ++itemi)item=items[itemi] , ( (function(xs) {var x,x0,xi,xl,xr;
